...
type FriendVerifyModel struct {
	...
	SendStatus           int8                        `gorm:"comment:发送方状态 4 删除" json:"sendStatus"`                       // 发送方状态 4 删除
	RevStatus            int8                        `gorm:"comment: 接收方状态 0 未操作 1 同意 2 拒绝 3 忽略 4 删除 " json:"revStatus"` // 接收方状态 0 未操作 1 同意 2 拒绝 3 忽略 4 删除
