...
type UserGroupSearchResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Result        map[uint32]int32       `protobuf:"bytes,1,rep,name=result,proto3" json:"result,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"` // 结果
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
